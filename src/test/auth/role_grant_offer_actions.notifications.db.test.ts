/**
 * End-to-end tests for the WS notification send sites in the role-grant-offer
 * RPC handlers. Injects a capturing `NotificationSender` into
 * `create_role_grant_offer_actions` and asserts that each lifecycle transition
...
describe_db('role_grant_offer_actions notifications', (get_db) => {
	describe('create fires role_grant_offer_received to the recipient', () => {
	...
	describe('retract fires role_grant_offer_retracted to the recipient', () => {
	...
	describe('decline fires role_grant_offer_declined to the grantor', () => {
