/**
 * Shared scaffolding for the `permit_offer.multi_actor.*.db.test.ts`
 * sibling suites.
 *
 ...
 * `permit_offer.multi_actor.db.test.ts` declared both as outer-scope
 ...
 * it up. Mirrors `./permit_offer_test_helpers.ts` for the rest of the
 * permit-offer integration scaffolding.
 *
 * @module
 */
...
import {create_route_specs, session_options} from './permit_offer_test_helpers.js';
