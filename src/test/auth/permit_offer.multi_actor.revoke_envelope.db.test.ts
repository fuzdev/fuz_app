/**
 * Multi-actor coverage — `permit_revoke` envelope on multi-actor accounts.
 *
 * The revoke audit event must name the actor the permit was actually
...
describe_db('permit_offer.multi_actor — revoke_envelope', (get_db) => {
