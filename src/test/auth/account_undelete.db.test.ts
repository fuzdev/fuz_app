...
import {ERROR_ACCOUNT_NOT_FOUND, ERROR_INSUFFICIENT_PERMISSIONS} from '$lib/http/error_schemas.ts';
...
import {query_account_by_id} from '$lib/auth/account_queries.ts';
