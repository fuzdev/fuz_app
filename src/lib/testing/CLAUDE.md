...
| `create_test_audit_emitter()`                         | No-op `AuditEmitter` for tests that don't assert on audit fan-out. `emit` / `emit_role_grant_target` resolve immediately; `notify` is a no-op; `on_event_chain` is empty.                                                                                                                                                                                                                                                                                                                                                           |
| `create_test_pool_audit_emitter(options)`             | Thin re-export of `create_audit_emitter` for DB-backed tests that need a real pool-backed emitter (e.g. the rollback-resilience test).                                                                                                                                                                                                                                                                                                                                                                                              |
