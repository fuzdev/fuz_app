...
./architecture.md for DB initialization and session details. See
./migrations.md for the schema-stability declaration and operator
recipes that govern local-daemon upgrade flow.
